...
#define TEXT_START_NUMBERED_LIST 0x90
#define TEXT_START_UNORDERED_LIST 0x91
#define TEXT_END_LIST 0x92
#define TEXT_NEW_BULLET 0x93
#define TEXT_SET_BULLET_NUMBER 0x94
#define TEXT_SET_LIST_LEVEL 0x95
#define TEXT_LIST_LEFT_SUBINDENT 0x96
#define TEXT_LEFT_SUBINDENT_LEVEL_MULTIPLIER 0x97
#define TEXT_BEGIN_LEFT_INDENT 0xA0
#define TEXT_END_LEFT_INDENT 0xA1
#define TEXT_BEGIN_RIGHT_INDENT 0xA2
#define TEXT_END_RIGHT_INDENT 0xA3
#define TEXT_BEGIN_PARAGRAPH_SPACING 0xA4
#define TEXT_END_PARAGRAPH_SPACING 0xA5
#define TEXT_NEW_LINE 0xB0
