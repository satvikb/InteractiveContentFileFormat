...
\subsubsection{Starting Container Layout ID}
The starting container LAYOUT ID is a ID COMPONENT that defines the container wide style used for the starting parent container.
...
\item 02 - Scale text size as a percent of the window width.
\item 03 - Scale text size as a percent of the window height.
\end{itemize}
